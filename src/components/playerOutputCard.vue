<template>
  ...
  <div
        ...
        <!--Useless class-->
          <span tp v-if="player.is_lust == 0 && player.is_CR == 0 && player.is_PI == 0"><img src="../assets/none.jpg"/></span>
        <!--Player details-->
...
<style lang="scss" scoped>
 .player {
      ...
      span {
        ...
        /* added padding for the useless class */
        &[tp] {
          padding-top: 0.5rem;
        ...
        /*Independant span element styles  */
        &[rl] {
          font-size: 110%;
      ...
      /*global styles for images in this component */
      img {
        border-radius: 50%;
      }
    }
